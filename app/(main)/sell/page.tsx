...
export default async function SellPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-5xl">
      <h1 className="text-3xl font-bold mb-2">Sell with Taeme Abakidan</h1>
      <p className="text-gray-600 mb-8">
        Producers and guides across the Dega Damot community can list products and experiences.
